...
- **Trigger:** Input describes a system architecture using specific technologies (e.g., "React", "PostgreSQL", "AWS Lambda") OR input includes an image.
- **Action:** You MUST call the \`create_architecture_diagram\` tool.
- **Reasoning:** The user has provided enough detail to draw a diagram.
- **Examples:** "create a REST API with Express and Redis", "draw a microservices architecture for a payment app"
    ...
    const tools = [
        ...
        },
        {
          ...
          function: {
            ...
            description: "LANE 2 - TEXT/IMAGE ONLY: Call this tool ONLY if the input describes a system with specific technologies (like 'Express', 'PostgreSQL', 'Redis') OR includes an image. DO NOT call this if the message contains 'github.com', 'gitlab.com', or 'bitbucket.org' - those require the codebase tool instead.",
            parameters: {
              type: "object",
              properties: {
        ...
        try {
            ...
            if (currentToolCall.name === 'codebase' && !codebaseProcessed) {
                ...
                try {
                    ...
                    console.log('✅ Sent Codebase Diagram Message');
