...
<!-- DIAGRAM_JSON
{
  "nodes": [
    ...
    {"id": "EvollaForProteinText2Text_modeling", "label": "EvollaForProteinText2Text (modeling_evolla)"},
    {"id": "EvollaForProteinText2Text_modular", "label": "EvollaForProteinText2Text (modular_evolla)"},
  ...
  "edges": [
    {"source": "EsmForProteinFolding", "target": "EsmPreTrainedModel", "label": "inherits"},
    {"source": "EvollaForProteinText2Text_modeling", "target": "EvollaPreTrainedModel", "label": "inherits"},
    {"source": "EvollaForProteinText2Text_modeling", "target": "GenerationMixin", "label": "inherits"},
    {"source": "EvollaForProteinText2Text_modular", "target": "EvollaPreTrainedModel", "label": "inherits"},
    {"source": "EvollaForProteinText2Text_modular", "target": "GenerationMixin", "label": "inherits"}
  ],
  "groups": [
    {"id": "esm_group", "label": "ESM Models", "nodes": ["EsmForProteinFolding"]},
    {"id": "evolla_group", "label": "Evolla Models", "nodes": ["EvollaForProteinText2Text_modeling", "EvollaForProteinText2Text_modular"]},
    {"id": "base_group", "label": "Base Classes", "nodes": ["EsmPreTrainedModel", "EvollaPreTrainedModel", "GenerationMixin"]}
  ]
}
-->
```mermaid
