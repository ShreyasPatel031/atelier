...
<!-- DIAGRAM_JSON
{
  "nodes": [
    ...
    {"id": "_cleanup_on_exit", "label": "_cleanup_on_exit"},
  ...
  "groups": [
    {
      ...
      "nodes": ["cleanup_expired_files", "cleanup_provider_files", "_cleanup_on_exit"]
    },
    {
      "id": "async_cleanup",
      "label": "Asynchronous Cleanup",
      "nodes": ["acleanup_expired_files", "delete_expired", "acleanup_provider_files", "acleanup_uploaded_files", "delete_one"]
    }
  ]
}
-->
